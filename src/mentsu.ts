...
export const enum Mentsu {
    ...
    NULL = 0x3e, MIN = 0x00, MAX = 0x3e,
    MASK = 0x3f, SHIFT = 6,
}

/**
 * int Mentsu to string (pretty print).
 * @export
 * @param {Mentsu} mentsu
 * @returns
 */
export function toString(mentsu: Mentsu) { return mentsuStringLookup[mentsu]; }
const mentsuStringLookup: ReadonlyArray<string> = [
    '111m', '123m', '222m', '234m',
    '333m', '345m', '444m', '456m',
    '555m', '567m', '666m', '678m',
    '777m', '789m', '888m', '999m',
...
export function isValid(mentsu: Mentsu) {
    const s = mentsuStringLookup[mentsu];
...
const anchorLookup: ArrayLike<Pai> = Uint8Array.of(
    ...
    31, 30, 32, 30, 33, 30, 34, 30, 35, 30, 36, 30, 37, 30, 30, 30,
);
...
const koutsuLookup: ArrayLike<Mentsu> = Uint8Array.of(
    ...
    0x3e, 0x30, 0x32, 0x34, 0x36, 0x38, 0x3a, 0x3c,
);
...
const shuntsuLookup: ArrayLike<Mentsu> = Uint8Array.of(
    ...
    0x29, 0x21, 0x23, 0x25, 0x27, 0x29, 0x2b, 0x2d, 0x3e, 0x3e,
